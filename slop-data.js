...
const SLOP = {
  meta: {
    ...
    premise: "When the same script comes out of twenty mouths in one afternoon, that's not a vibe — that's logistics. Logistics cost money, and money leaves records: FARA filings, FEC reports, IRS 990s, federal contracts. This site tracks three things: WHO PAYS (the money edges, each graded by its paper), THE WAVES (timestamped clusters of the same talking points — coordination shows up in timing even when the money hides), and THE 180s (when a big mouth pivots into the slop, dated, with before/after receipts).",
    check_yourself: [
  ...
  /* ——— THE MONEY: payer → mouth edges, each graded by its paper ——— */
  money: [
    {
      id: "israel-mfa-clocktower",
      payer: "Government of Israel (Ministry of Foreign Affairs, via Havas Media Germany GmbH)",
    ...
    },
    {
      ...
      mouth: "Salem Media Group — and everything it distributes",
      ...
      grade: "reported",
      basis: "Salem-integration language: in the FARA scope (documented). The CSO role and show mechanics: trade-press and investigative reporting.",
      sources: [
