...
const SLOP = {
  ...
  people: [
    ...
    { id: "megynkelly", name: "Megyn Kelly", outlet: "The Megyn Kelly Show (SiriusXM)",
      charge: "guilt-narrative amplifier and TPUSA friend — verified quotes only (re-checked against caption pulls Jul 20 2026): Dec 2025, after Robinson's first in-person court appearance: “Look, Tyler Robinson did this. Seems very clear to me… I want him dead. I want the death penalty handed down against him and anyone who helped him. And I will be gleeful on the day it is carried out.” Jul 8 2026, on-air with Posobiec: “There's something completely inhuman about this behavior” (Posobiec: “It's inhuman behavior. It's unhuman behavior”), and same week: “he'll be convicted and he will likely be sentenced to death and I won't shed one tear.” (An earlier draft's “everybody relax” and “sick animal” quotes did not survive verification and are withdrawn.)" }
  ],
  ...
  money: [
    ...
    { from: "havas", to: "bridges", grade: "documented", date: "2025-09-26",
      note: "FARA #7652 (Bridges Partners LLC, Uri Steinberg & Yair Levi), filed Sept 26, 2025 — $900K via Havas for the “Esther Project”: an influencer network of ~14–18 anonymous US creators (~25–30 posts/month per the Havas insertion order; the widely-reported ~$7,000/post figure is press-derived, not in the filing), Jun–Nov 2025. Public Citizen filed a FARA complaint asking DOJ to compel the influencer names. Same Israel→Havas pipeline as Clock Tower X, filed 8 days later.",
      sources: [
    ...
    { from: "havas", to: "showfaith", grade: "documented", date: "2025-09-27",
      note: "FARA #7653 (Show Faith By Works LLC, registrant Chad Schnitger — president of the CA chapter of Ralph Reed's Faith & Freedom Coalition, a role Reed's spokesman disavows), filed Sept 27, 2025 — up to $4.1M via Havas ($3.26M firm contract + $835K optional per the filing; $325,881 already received 9/18/25) for a church-geofencing campaign targeting 303 megachurches (CA 219, NV 14, AZ 38, CO 32) + 39 Christian colleges in the western US (a mobile museum, pro-Israel geofencing/digital, “track attendees and continue to target with ads”). Same Israel→Havas pipeline as Clock Tower X.",
      sources: [
